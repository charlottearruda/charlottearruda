...
## Skills
**GIS and Spatial Analysis:** ArcGIS Pro, QGIS, ArcGIS Online, Experience Builder, StoryMaps, Survey123, Field Maps, Leaflet, Geocoding, spatial analysis, ModelBuilder, DEM and terrain analysis, LiDAR and point cloud processing, 3D modelling

**Programming:** Python, R, SQL, JavaScript

**Data Analysis & Statistics:** GeoDa, SPSS, Excel
...
The interactive dashboard visualizes the index results, allowing users to explore spatial patterns for municipal decision-making purposes. The dashboard includes an index for all of Ontario and three comprehensive municipal case studies.
...
The outputs provide indicators of infrastructure impact, allowing for comparative assessment of highway route impacts.
